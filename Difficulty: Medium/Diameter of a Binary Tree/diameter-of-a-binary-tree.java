...
class Solution {
    ...
    // Helper function to compute both height and diameter
    private TreeInfo diameterHelper(Node node) {
        if (node == null) {
        ...
        // Possible diameters: through root or within left/right subtrees
